...
Golang Proxy Bridge (Embedded)
Native C++ Multi-Threaded Engines
Volarus Vanguard UI (C++/ImGui)
DirectX11 Render Loop
WinMain Core Controller
ArpEngine
ShaperEngine
SnifferEngine
SpeedTestEngine
...
Compilation: Run build.bat from the root directory. The script will automatically:
